...
function add(event) {
    ...
    query = `pid=${bank.value}&account=${account.value}&bank=${bank.value}&type=${type.value}
    &inibalance=${inibalance.value}&interest=${interest.value}&minbalance=${minbalance.value}&maxwithdraws=${maxwithdraws.value}`
    //console.log(query)
